...
export default function AboutPage() {
  return (
    <>
      <h1 className="mb-8" data-testid="about-heading">About Me</h1>

      {/* Section 1: Photo + Name + Description */}
      {/* SWH Candidate */}
      <section className="app-surface p-6 mb-8 flex flex-col md:flex-row items-center gap-6" data-testid="about-profile-section">
        <Image
        ...
        <div className="flex-1" data-testid="about-profile-details">
          <h2 className="mb-2" data-testid="about-profile-name">
            Michael Crowley
          </h2>
      ...
      {/* SWH Candidate */}
      <section className="app-surface p-6 mb-8" data-testid="about-background-section">
        <h2 className="mb-4" data-testid="about-background-title">Background</h2>
      ...
      {/* SWH Candidate */}
      <section className="app-surface p-6" data-testid="about-hobbies-section">
        <h2 className="mb-4" data-testid="about-hobbies-title">
          Interests & Hobbies
        </h2>
